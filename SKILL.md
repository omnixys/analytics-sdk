<!-- repository: packages/ts/analytics-sdk | kind: PACKAGE | stack: ts-package -->

# analytics-sdk — Skill: Package Development

> Workflow for analytics-sdk (packages/ts/analytics-sdk). Execute this workflow before, during, and
...
- This package is published (`@omnixys/analytics-sdk`); consumers pin versions and rely on SemVer.
