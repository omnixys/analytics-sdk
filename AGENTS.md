...
> Repository development instructions for **analytics-sdk** (Shared Package).
> Stack: ts-package. Generated as part of the Omnixys repository-policy rollout.

## Repository Overview

Omnixys analytics SDK for TypeScript.

- Repository path: `packages/ts/analytics-sdk` (relative to the Omnixys root)
...
Published package; SemVer discipline required.
